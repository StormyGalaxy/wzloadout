                                ...
                                <div style={{ padding: '10px' }}> {/* Original inner padding div */}
                                    ...
                                    <section className="mt-5"> {/* Added more top margin */}
                                        ...
                                        <ul className="list-unstyled mt-3"> {/* Use list-unstyled for cleaner look maybe */}
                                            ...
                                            <li className="mb-2">
                                                <span className="fw-semibold">Consent & Use Limitation:</span> We will collect and use personal information solely
                                            ...
                                            <li className="mb-2">
                                                <span className="fw-semibold">Data Retention:</span> We will only retain personal information as long as
                                                necessary for the fulfillment of those purposes.
                                            </li>
                                            <li className="mb-2">
                                                <span className="fw-semibold">Collection Method:</span> We will collect personal information by lawful and
                                                fair means and, where appropriate, with the knowledge
                                                or consent of the individual concerned.
                                            </li>
                                            <li className="mb-2">
                                                <span className="fw-semibold">Data Quality:</span> Personal data should be relevant to the purposes for
                                                which it is to be used, and, to the extent necessary
                                                for those purposes, should be accurate, complete, and
                                                up-to-date.
                                            </li>
                                            <li className="mb-2">
                                                <span className="fw-semibold">Security Safeguards:</span> We will protect personal information by reasonable
                                                security safeguards against loss or theft, as well as
                                                unauthorized access, disclosure, copying, use or
                                                modification.
                                            </li>
                                            <li className="mb-2">
                                                <span className="fw-semibold">Openness:</span> We will make readily available to customers
