              ...
              <Col lg={9} xl={8}>
                ...
                <section className="mt-4">
                  ...
                  <ul className="list-group list-group-flush mt-3 mb-3">
                    ...
                    <li className="list-group-item ps-0">
                      ...
                      any reason whatsoever, without your consent, other than
                ...
                <section className="mt-4">
                  ...
                  <p>
                    ...
                    accessible by those authorized with special access rights to
                    such systems, and are required to keep the information
                    confidential.
                  </p>
                  <p>
                    After a transaction, your private information (credit cards,
                    social security numbers, financials, etc.) may not be stored
                    on our servers.
                  </p>
                </section>
                ...
                <section className="mt-4">
                  ...
                  <p>
                    ...
                    site&apos;s or service provider&apos;s systems to recognize
                ...
                <section className="mt-4">
                  ...
                  <p>
                    ...
                    knowingly collect any information from anyone under 13 years
