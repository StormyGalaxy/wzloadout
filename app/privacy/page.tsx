                        ...
                        <Row className="justify-content-md-center">
                            ...
                            <Col lg={9} xl={8}>
                                ...
                                <p className="lead mb-4"> {/* Added lead class */}
                                    ...
                                    Site and all products and services offered by Techreanimate.
                                </p>
                                ...
                                <section className="mt-4">
                                    ...
                                    <p>
                                        ...
                                        address, phone number or other details. You may, however, visit
                                ...
                                <section className="mt-4">
                                    ...
                                    <ul className="list-group list-group-flush mt-3 mb-3">
                                        ...
                                        <li className="list-group-item ps-0">
                                            <strong>To improve our website:</strong> We continually strive
                                        ...
                                        <li className="list-group-item ps-0">
                                            <strong>To administer features:</strong> Such as a contest,
                                            promotion, survey or other site feature.
                                        </li>
                                        <li className="list-group-item ps-0">
                                            <strong>To send periodic emails:</strong> The email address you
                                            provide may be used to send you information and updates, in
                                            addition to receiving occasional company news, updates, etc.
                                ...
                                <section className="mt-4">
                                    ...
                                    <p>
                                        ...
                                        social security numbers, financials, etc.) may not be stored on
                                        our servers.
                                    </p>
                                </section>
