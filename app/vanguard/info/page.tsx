        ...
        <Row className="shadow-lg p-3 bg-body rounded mb-4">
          <Col lg={7} className="text-center">
            <p>
              ...
              strategy or preparing to face the undead hordes, we&apos;ve
              compiled the information you need. Our loadout section details
              every multiplayer <strong>weapon</strong>, <strong>perk</strong>,
              piece of <strong>equipment</strong>, <strong>wildcard</strong>,
              and <strong>killstreak</strong> available. For Zombies slayers,
