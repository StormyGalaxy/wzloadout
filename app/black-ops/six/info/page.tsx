      ...
      <Container>
        ...
        <Row className="shadow-lg p-3 bg-body rounded mb-4">
          <Col lg={7} className="text-center">
            <p>
              Prepare for clandestine operations in the Gulf War era with our
              Call of Duty: Black Ops 6 intelligence center. This section
              provides the vital data you need for the latest Black Ops
              installment. Master the multiplayer arena with detailed
              information on <strong>Weapons</strong>, tactical{" "}
              <strong>Equipment</strong>, essential <strong>Perks</strong>,
              powerful <strong>Wildcards</strong>, and game-changing{" "}
              <strong>Streaks</strong>. For Zombies aficionados, get ready for
              the return of round-based chaos! Explore guides on the launch{" "}
              <strong>Maps</strong>, classic <strong>GobbleGums</strong>,
              essential <strong>Ammo Mods</strong>, rechargeable{" "}
              <strong>Field Upgrades</strong>, and the <strong>Augments</strong>{" "}
              that modify them. Find all the links on this page.
            </p>
          </Col>
          <Col lg={5}>
