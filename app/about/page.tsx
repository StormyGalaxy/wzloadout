        ...
        <Row className="shadow-lg mt-3 p-3 bg-body rounded">
          ...
          <Col lg={8}>
            <p className="lead fs-6 lh-lg text-center">
              ...
              fans! Created to add fun and unpredictability to your sessions,
              our site offers robust class generators for{" "}
              ...
              <strong>Warzone</strong>. Looking for an extra layer of
              randomness? Let our generator pick your next{" "}
