      ...
      <Container>
        ...
        <Row className="shadow-lg p-3 bg-body rounded mb-4">
          <Col lg={7} className="text-center">
            <p>
              Return to the European theatre with our Call of Duty: WWII
              information center. Get ready for boots-on-the-ground action by
              diving into the specifics of multiplayer combat, including all
