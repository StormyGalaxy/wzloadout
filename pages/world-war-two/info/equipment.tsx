...
export default function WorldWarTwoEquipment() {
  const navLinks = [
    { label: "Home", href: "/" },
  ...
  useEffect(() => {
    const dataList = getEquipment("world-war-two");
    setData(dataList);
  ...
  return (
    <>
      <Head>
        <title>World War Two Equipment</title>
        <link rel="manifest" href="/manifest.json" />
        <meta
          name="description"
          content="View all equipment in World War Two."
        />
        <meta
          name="keywords"
