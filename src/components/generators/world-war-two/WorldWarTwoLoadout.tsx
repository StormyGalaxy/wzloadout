    ...
    <>
      ...
      <Row className='justify-content-md-center'>
        ...
        <Col sm className='text-center mb-3 mb-md-0'>
          <SimpleGeneratorView
            ...
            title='Lethal'
            value={
              equipment.lethal.name + (basic === 'Saboteur' || basic === 'Concussed' ? ' x2' : '')
            }
          />
        </Col>
      </Row>
      ...
      <Row className='mb-5'>
        <Col sm className='text-center'>
          <SimpleGeneratorView isGenerating={isGenerating} title='Division' value={division} />
        </Col>
        <Col sm className='text-center'>
          <SimpleGeneratorView isGenerating={isGenerating} title='Basic Training' value={basic} />
        </Col>
        <Col sm className='text-center'>
...
async function fetchLoadoutData(setData) {
  ...
  try {
    ...
    if (basic === 'Wanderlust') {
      ...
      weapons.primary.weapon = fetchWeapon('melee', game, weapons.secondary.weapon.name);
