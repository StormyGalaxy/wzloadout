...
export default function ModernWarfareThreeLoadout() {
  const { data, isLoading, isGenerating, generateLoadout } = useModernWarfareThreeGenerator();
  ...
  const equipmentData = [
    ...
    { title: 'Vest', value: equipment?.vest?.name ?? '' },
  ];
