...
export default function ClientDatabaseProviderWrapper({ children }: { children: React.ReactNode }) {
  return <DynamicDatabaseProviderInternal>{children}</DynamicDatabaseProviderInternal>;
}
