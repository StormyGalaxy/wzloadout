...
const CodBadge = ({
  ...
  const badgeClasses = ['d-flex', 'align-items-center', styles.baseBadge, styles[badgeOverwrite]];
  ...
  return (
    <Badge className={badgeClasses.join(' ')} bg={variant ? variant : 'success'}>
      {imgSrc && (
        <Image
          src={imgSrc}
          alt={`${name} icon`}
          height={16}
          width={16}
          style={{ height: '1.1em', width: 'auto', marginRight: '0.3em' }}
        />
      )}
